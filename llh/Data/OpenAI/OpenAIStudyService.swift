...
/// Word, phrase and grammar study generation via Chat Completions (`POST /v1/chat/completions`).
struct OpenAIStudyService: Sendable {
    ...
    func buildPhrasesStudyData(
        ...
        let dto: PhrasesResponseDTO = try await chatClient.completeJSON(
            apiKey: apiKey,
            modelID: modelID,
            temperature: 0.2,
