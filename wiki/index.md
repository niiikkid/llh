...
|---------|---------|---------|
| [v0.2 Product Plan](refactoring/v0-2-product-plan.md) | v0.2: **Inc. 1, 2, 10 done**; **Inc. 3 partial** (settings route, layout pending); 4–9 planned. | 2026-05-27 |
...
| [Refactoring Phase 8 UI Decomposition](refactoring/refactoring-phase-8-ui-decomposition.md) | Phase 8 завершена: feature views + `StructuredFormattedText`; v0.2 inc. 1–2, 10 (`SessionsListView`, `AppMainRoute`, `MainWindowActivator`). | 2026-05-27 |
...
| [Refactoring Phase 4 Presentation](refactoring/refactoring-phase-4-presentation.md) | Phase 4: 6 feature VMs; v0.2 inc. 2 — `SessionsListView` + translations-only `HistoryView`. | 2026-05-27 |
