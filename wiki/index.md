...
|---------|---------|---------|
| [v0.2 Product Plan](refactoring/v0-2-product-plan.md) | v0.2: **Inc. 1–3, 10 done**; **Inc. 4 next** (translation result state); 5–9 planned. | 2026-05-27 |
...
| [Refactoring Phase 9 Testing Strategy](refactoring/refactoring-phase-9-testing-strategy.md) | Phase 9: `Phase9*` integration/migration/prompt/VM tests; UI launch (RU product name) + settings route/back; migration verify failure; bootstrap JSON fallback. | 2026-05-27 |
| [Refactoring Phase 8 UI Decomposition](refactoring/refactoring-phase-8-ui-decomposition.md) | Phase 8 завершена: feature views + `StructuredFormattedText`; v0.2 inc. 1–3, 10 (`SettingsView` layout, sessions, single window). | 2026-05-27 |
...
| [Refactoring Phase 4 Presentation](refactoring/refactoring-phase-4-presentation.md) | Phase 4: 6 feature VMs; v0.2 inc. 2–3 — sessions route + full-page `SettingsView`. | 2026-05-27 |
