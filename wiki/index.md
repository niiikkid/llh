...
|---------|---------|---------|
| [v0.2 Product Plan](refactoring/v0-2-product-plan.md) | v0.2: **Inc. 1–7, 10 done**; **Inc. 8 next** (reading overview); Inc. 9 planned. | 2026-05-27 |
...
| [Refactoring Phase 9 Testing Strategy](refactoring/refactoring-phase-9-testing-strategy.md) | Phase 9: `Phase9*` tests; UI smoke; v0.2 inc. 4–7 (resolver, grammar, automation, overlay dismiss). | 2026-05-27 |
| [Refactoring Phase 8 UI Decomposition](refactoring/refactoring-phase-8-ui-decomposition.md) | Phase 8: feature views + `StructuredFormattedText`; v0.2 inc. 1–7, 10 (sessions, study, overlay close). | 2026-05-27 |
...
| [Refactoring Phase 4 Presentation](refactoring/refactoring-phase-4-presentation.md) | Phase 4: feature VMs; v0.2 inc. 2–7 — sessions, settings, study, overlay dismiss via coordinator. | 2026-05-27 |
