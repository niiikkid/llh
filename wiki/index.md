...
|---------|---------|---------|
| [v0.2 Product Plan](refactoring/v0-2-product-plan.md) | v0.2: **Inc. 1–5, 10 done**; **Inc. 6 next** (session automation); 7–9 planned. | 2026-05-27 |
...
| [Refactoring Phase 9 Testing Strategy](refactoring/refactoring-phase-9-testing-strategy.md) | Phase 9: `Phase9*` tests; UI smoke; v0.2 inc. 4 resolver + inc. 5 `Phase3LoadGrammarStudyUseCaseTests`. | 2026-05-27 |
| [Refactoring Phase 8 UI Decomposition](refactoring/refactoring-phase-8-ui-decomposition.md) | Phase 8: feature views + `StructuredFormattedText`; v0.2 inc. 1–5, 10 (study tabs, sessions, settings, translation state). | 2026-05-27 |
...
| [Refactoring Phase 4 Presentation](refactoring/refactoring-phase-4-presentation.md) | Phase 4: feature VMs; v0.2 inc. 2–5 — sessions, settings, translation UI, words/grammar tabs. | 2026-05-27 |
| [Refactoring Phase 3 Use Cases](refactoring/refactoring-phase-3-use-cases.md) | Phase 3: 8 use cases (+ `LoadGrammarStudyUseCase` v0.2 inc. 5); profile rename/delete; phrase API removed in Phase 10. | 2026-05-27 |
