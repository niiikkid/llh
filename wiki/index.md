...
|---------|---------|---------|
| [v0.2 Product Plan](refactoring/v0-2-product-plan.md) | v0.2: **Inc. 1–8, 10 done**; **Inc. 9 next** (Dock badge). | 2026-05-27 |
...
| [Refactoring Phase 9 Testing Strategy](refactoring/refactoring-phase-9-testing-strategy.md) | Phase 9: `Phase9*` tests; UI smoke; v0.2 inc. 4–8 (resolver, grammar, automation, overlay, reading details). | 2026-05-27 |
| [Refactoring Phase 8 UI Decomposition](refactoring/refactoring-phase-8-ui-decomposition.md) | Phase 8: feature views + `StructuredFormattedText`; v0.2 inc. 1–8, 10 (sessions, study, overlay, reading overview). | 2026-05-27 |
...
| [Refactoring Phase 4 Presentation](refactoring/refactoring-phase-4-presentation.md) | Phase 4: feature VMs; v0.2 inc. 2–8 — sessions, settings, study, overlay dismiss, reading sequence. | 2026-05-27 |
...
| [Refactoring Phase 2 Domain Models](refactoring/refactoring-phase-2-domain-models.md) | Phase 2: `Domain/Models`; v0.2 inc. 6 automation flags; inc. 8 `SessionReadingSequenceItem` study fields; Phase 10 `overlayPrimaryText`. | 2026-05-27 |
