...
App/
  ...
  DockLanguageBadgeController.swift — v0.2 inc. 9: Dock badge from active session language
Presentation/
  Main/
  ...
  History/
    ...
    SessionReadingOverviewView.swift  — v0.2 inc. 8: expandable word/grammar details
...
- [v0.2 Product Plan](v0-2-product-plan.md) — v0.2 Increments 1–10 complete on Presentation/App shell (dock badge inc. 9)
