...
Presentation/
  ...
  History/
    ...
    SessionsListView.swift     — session CRUD page (v0.2 inc. 2)
...
- [v0.2 Product Plan](v0-2-product-plan.md) — v0.2 Increments 1–5 and 10 on Presentation shell
