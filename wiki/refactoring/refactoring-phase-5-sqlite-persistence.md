...
**Phase 6** — OpenAI modernization — см. [Phase 6](refactoring-phase-6-openai-integration.md) (PR 2–3: HTTP + models; далее PR 4 AI OCR).

Опционально в рамках Phase 5: async save/load, UX при битом JSON.

## See Also

- [Refactoring Phase 6 OpenAI Integration](refactoring-phase-6-openai-integration.md) — следующий этап после persistence
